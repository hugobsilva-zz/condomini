...
const HomeStack = createStackNavigator({
  Home: {
    screen: HomeScreen,
    navigationOptions: ({navigation}) => ({
      header: <Header search tabs title="Menu" navigation={navigation} />,
    })
  },
  Settings: {
    screen: SettingsScreen,
    navigationOptions: ({navigation}) => ({
      header: <Header back title="Configurações" navigation={navigation} />,
    })
  },
  Components: {
    screen: ComponentsScreen,
...
const AppStack = createDrawerNavigator(
  {
    ...
    Dashboard: {
      ...
      navigationOptions: (navOpt) => ({
        drawerLabel: ({focused}) => (
          <Drawer focused={focused} screen="Home" title="Condomini" />
        ),
      }),
    },
    Woman: {
      ...
      navigationOptions: (navOpt) => ({
        drawerLabel: ({focused}) => (
          <Drawer focused={focused} screen="Pro" title="Portaria" />
        ),
      }),
    },
    Man: {
      ...
      navigationOptions: (navOpt) => ({
        drawerLabel: ({focused}) => (
          <Drawer focused={focused} screen="Pro" title="Avisos" />
        ),
      }),
    },
    Kids: {
      ...
      navigationOptions: (navOpt) => ({
        drawerLabel: ({focused}) => (
          <Drawer focused={focused} screen="Pro" title="Reservas" />
        ),
      }),
    },
    NewCollection: {
      ...
      navigationOptions: (navOpt) => ({
        drawerLabel: ({focused}) => (
          <Drawer focused={focused} screen="Pro" title="Financeiro" />
        ),
      }),
    },
    Profile: {
    ...
    SignIn: {
      ...
      navigationOptions: (navOpt) => ({
        drawerLabel: ({focused}) => (
          <Drawer focused={focused} screen="Pro" title="Entrar" />
        ),
      }),
    },
    SignUp: {
      ...
      navigationOptions: (navOpt) => ({
        drawerLabel: ({focused}) => (
          <Drawer focused={focused} screen="Pro" title="Registrar" />
        ),
      }),
    },
  },
