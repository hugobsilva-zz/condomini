...
export default class Settings extends React.Component {
  ...
  render() {
    const recommended = [
      { title:  "Usar o FaceID para entrar", id: "face", type: "switch" },
      { title: "Auto-Bloqueio de segurança", id: "autolock", type: "switch" },
      { title: "Notificações", id: "Notifications", type: "button" },
    ];

    const payment = [
      { title: "Configurar Pagamento", id: "Payment", type: "button" },
      { title: "Configurar Cartões-Presente", id: "gift", type: "button" },
    ];
    
    const privacy = [
      { title: "Termos de Uso", id: "Agreement", type: "button" },
